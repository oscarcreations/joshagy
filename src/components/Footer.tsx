          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-none">
                ...
                <span className="block text-[10px] text-orange-500 font-bold tracking-[0.2em] uppercase">
                  Company Ltd
                </span>
              </div>
            </div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-xs">
              Excellence in civil engineering and mining support. Delivering
              high-quality construction solutions across the Western Region of
              Ghana.
            </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="block text-slate-200 text-sm font-bold mt-0.5 hover:text-orange-500 transition"
                  >
                    +233 24 465 5948
                  </a>

                  <a
                    href="tel:+233312323688"
                    className="block text-slate-200 text-sm font-bold mt-0.5 hover:text-orange-500 transition"
                  >
                    +233 31 232 3688
                  </a>
        ...
        <div className="py-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            <p className="text-slate-500 text-sm font-medium">
              © {currentYear}{" "}
              <span className="text-slate-300">Joshagy Company Limited</span>.
            </p>
